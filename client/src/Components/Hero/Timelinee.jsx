  ...
  return (
    <section>
      <div className="bg-black text-white py-8">
        <div className="container-timeline mx-auto flex flex-col items-start md:flex-row my-12 md:my-24">
          ...
          <div className="ml-0 md:ml-12 lg:w-2/3 sticky">
            <div className="container-timeline mx-auto w-full h-full">
              ...
              <img className="mx-auto -mt-36 md:-mt-36" src="https://user-images.githubusercontent.com/54521023/116968861-ef21a000-acd2-11eb-95ac-a34b5b490265.png" alt="" />
            </div>
          </div>
        </div>
      </div>
